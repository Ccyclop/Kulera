      ...
      <main className="page-main">
        ...
        <Stagger as="section" className="mt-8 grid gap-5" stagger={0.08} childVariant="fadeUp">
          ...
          <article className="soft-card rounded-[28px] p-5 md:p-7">
            <div className="mb-5">
              <h2 className="text-[28px] font-black leading-tight">{t("ანგარიში")}</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">{t("პაროლი და შეტყობინებების პრეფერენციები.")}</p>
            </div>
          ...
          <article className="soft-card flex flex-col gap-4 rounded-[28px] p-5 md:flex-row md:items-center md:justify-between md:p-7">
            <div>
              <h2 className="text-[20px] font-black leading-tight">{t("სესიის დასრულება")}</h2>
              <p className="mt-1 text-sm leading-relaxed text-muted">{t("გამოდი ანგარიშიდან — შენი მონაცემები შენარჩუნდება.")}</p>
            </div>
            <SignOutButton />
          </article>
