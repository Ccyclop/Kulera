  ...
  return (
    <PageShell>
      <main className="page-main">
        <Reveal as="section" className="hero-panel min-h-[280px]" variant="fadeUp">
        ...
        <section className="mt-8">
          {categories.length > 0 ? (
            <Stagger as="div" className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6" stagger={0.04} childVariant="popIn">
